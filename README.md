...
Скрипт для скачивания русскоязычных HTML-страниц, извлечения токенов, лемматизации, построения индекса, булевого поиска, расчета TF-IDF и векторного поиска.
